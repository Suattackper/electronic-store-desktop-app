    ...
    public partial class frmNhanVien : Form
    {
        ...
        private void dtgvNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                cbQuyen.Text = selectedRow.Cells[2].Value.ToString();
                ...
                byte[] imageData = NhanVienBUS.Instance.getAnh(selectedRow.Cells[0].Value.ToString());
                if (imageData != null)
                {
                    //Chỉnh ảnh phù hợp với pbAvatar
                    pbAvatar.SizeMode = PictureBoxSizeMode.Zoom;
                    // Đặt hình ảnh cho PictureBox
                    pbAvatar.Image = Image.FromStream(new MemoryStream(imageData));
                }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            nv.MaQuyen = int.Parse(QuyenBUS.Instance.getMaQuyen(cbQuyen.Text));
            ...
            using (MemoryStream memoryStream = new MemoryStream())
            {
                ...
                {
                    pbAvatar.Image.Save(memoryStream, pbAvatar.Image.RawFormat);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            string macuahang = dtgvNhanVien.Rows[rowIndex].Cells[0].Value.ToString();
